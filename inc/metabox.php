...
<div class="flex items-center ps-4 border border-blue-200 rounded dark:border-gray-700">
    ...
    <button data-source="wp-block-post-title" class="translate-button absolute bottom-0 right-0 px-3 flex items-center h-9 bg-gray-500 text-white rounded-r-lg"><i class="fa-solid fa-language mr-2"></i> Translate from native</button>
    </div>';
...
<div class="flex flex-row items-center gap-4">
    ...
    echo '" autocomplete="off" placeholder="">
    <button data-source="political-claim" class="translate-button absolute bottom-0 right-0 px-3 flex items-center h-9 bg-gray-500 text-white rounded-r-lg"><i class="fa-solid fa-language mr-2"></i> Translate from native</button>
    </div>';
...
<div class="flex flex-row items-center gap-4">
    ...
    echo '" autocomplete="off" placeholder="">
    <button data-source="debunk-claim" class="translate-button absolute bottom-0 right-0 px-3 flex items-center h-9 bg-gray-500 text-white rounded-r-lg"><i class="fa-solid fa-language mr-2"></i> Translate from native</button>
    </div>';
