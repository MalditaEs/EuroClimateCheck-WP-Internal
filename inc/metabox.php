...
<label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="claim-date-published">Claim Date Published:</label>
  <input class="w-full" type="date" style="height: 2.2em" id="claim-date-published" name="political-claim-date-published" value="' . (isset($data['type']) && $data['type'] === 'Factcheck' && isset($data['itemReviewed']['datePublished']) ? $data['itemReviewed']['datePublished'] : '') . '">
</div>';
...
<div class="flex flex-row items-center gap-4">
    ...
    $claimPublishedDate = '<div>
<label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="claim-date-published">Claim Date Published:</label>
  <input class="w-full" type="date" style="height: 2.2em" id="claim-date-published" name="debunk-claim-date-published" value="' . (isset($data['type']) && $data['type'] === 'Debunk' && isset($data['itemReviewed']['datePublished']) ? $data['itemReviewed']['datePublished'] : '') . '">
</div>';
...
function ee24_admin_notice()
{
    ...
    if ($success !== false) {
        echo '<div class="notice notice-success is-dismissible">';
            echo 'The EE24 Repository has been updated: ' . esc_html($success);
        echo '</div>';
    }
