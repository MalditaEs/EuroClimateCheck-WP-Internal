...
function claim_review_admin_style()
{
    ...
    if (get_option('ee24-compat')) {
        wp_register_style('claim_review_admin_css', EE24_PLUGIN_URL . '/css/styles.css', false, $plugin_data['Version']);
        wp_enqueue_style('claim_review_admin_css');
    } else {
        wp_register_style('claim_review_admin_css', EE24_PLUGIN_URL . '/css/full-styles.css', false, $plugin_data['Version']);
        wp_enqueue_style('claim_review_admin_css');
    }
